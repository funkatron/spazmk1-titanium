...
Spaz.Update.compareVersions = function(current, newest) {
	...
	console.info('current:'+current+' ('+typeof(current)+')')
	console.info('newest:'+newest+' ('+typeof(newest)+')')
...
Spaz.Update.deleteExisting = function() {
	var existingFile = Titanium.Filesystem.getApplicationDataDirectory().resolvePath("Spaz-Newest.air");
	if (existingFile.exists) {
		console.info('Existing file; will now delete')
...
Spaz.Update.downloadNewest = function(url) {
	...
	function loaded(event) {
		Spaz.dump("Loaded...");
		Spaz.dump(event);
		// console.info(urlStream.bytesAvailable);
	...
	function writeAirFile() {
		...
		var file = Titanium.Filesystem.getApplicationDataDirectory().resolvePath("Spaz-Newest.air");
