...
function Spaz_Tooltip(opts) {
	...
	// console.info('================================');
	// console.info('FROM: '+this.el.outerHTML);
	// console.info("opts: "+this.event);
	// console.info("opts: "+this.el);
	// console.info("opts: "+this.str);
	// console.info("opts: "+this.previewurl);
	// console.info("opts: "+this.reply_status_id);
	// console.info("opts: "+this.reply_screen_name);
	// 
...
Spaz_Tooltip.prototype.show = function() {
	...
	*/
	...
	//console.info('delaying tooltip "'+this.str+'" for 500 mseconds');
	Spaz_Tooltip_Timeout = setTimeout(delayedShow, Spaz.Prefs.get('window-tooltipdelay'));

	function delayedShow() {
		console.info('showing tooltip "' + thisTT.str + '"');
		console.info('reply_status_id' + thisTT.reply_status_id);
		...
		*/
			...
			console.info('This is an Reply preview tooltip');
			var previewid = "preview-status-" + thisTT.reply_status_id;
			console.info('previewid = ' + previewid);
			$('#tooltip').children('.preview').attr('id', previewid);
		...
		*/
			...
			if (thisTT.previewurl.search(/^http:\/\//i) > -1) {
				...
				if (twitpicMatch != null)
				{
					...
					{
						console.info("Could not find the width of the tooltip window " + width);
					}
				}
		...
		// console.info('setting tooltip hide timeout');
		// console.info('Tooltip hide delay:'+Spaz.Prefs.get('window-tooltiphidedelay'));
